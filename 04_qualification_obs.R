  ...
  # Idee : apres avoir calculer le nombre de fois d'observer une espece communes dans une liste ==> calcul de la proba de l'observer par un tirage aléatoire
    ...
    # tirage avec poids sans remise -----
       ...
       for(i in 1:10000){
         ...
         tir.31esp <- append(tir.31esp,as.character(sample(x = obs.esp$Nom_espece,size=31,replace=FALSE,prob = obs.esp$prob)))
      ...
      # test pour tirage de 2 esp (proba de trouver au moins une espece rare - bootstrap) ----
